...
void main() {
  group('captureOpponents', () {
    test('captures an opponent piece sharing the same global cell', () {
      ...
      final opponent = const LudoPiece(id: 4, playerIndex: 1, trackPosition: 2);
    ...
    test('never captures on a safe cell', () {
      ...
      final opponentOnStart = const LudoPiece(
        id: 4,
        playerIndex: 1,
        trackPosition: 0,
      );
